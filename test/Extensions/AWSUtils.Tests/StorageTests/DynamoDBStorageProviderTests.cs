...
namespace AWSUtils.Tests.StorageTests {
  ...
  public class DynamoDBStorageProviderTests {
    ...
    public DynamoDBStorageProviderTests(ITestOutputHelper output,
                                        TestEnvironmentFixture fixture) {
      this.output = output;
      this.fixture = fixture;
      providerCfgProps["DataConnectionString"] =
    ...
    InitDynamoDBGrainStorage(DynamoDBStorageOptions options) {
      DynamoDBGrainStorage store =
          ActivatorUtilities.CreateInstance<DynamoDBGrainStorage>(
              this.providerRuntime.ServiceProvider, "StorageProviderTests",
              options);
    ...
    private Task<DynamoDBGrainStorage>
    InitDynamoDBGrainStorage(bool useJson = false) {
      var options = new DynamoDBStorageOptions{
          Service = AWSTestConstants.Service, UseJson = useJson};
    ...
    private async Task Test_PersistenceProvider_Read(
      ...
      var reference = this.fixture.InternalGrainFactory.GetGrain(
          grainId.IsDefault ? GrainId.Create("test",
