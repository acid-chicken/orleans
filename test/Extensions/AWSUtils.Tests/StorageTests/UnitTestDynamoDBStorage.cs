...
namespace AWSUtils.Tests.StorageTests {
  ...
  internal class UnitTestDynamoDBTableData {
    ...
    public UnitTestDynamoDBTableData(string data, string partitionKey,
                                     string rowKey) {
      StringData = data;
    ...
    public UnitTestDynamoDBTableData Clone() {
      return new UnitTestDynamoDBTableData{StringData = this.StringData,
  ...
  internal class UnitTestDynamoDBStorage : DynamoDBStorage {
    ...
    public UnitTestDynamoDBStorage()
        : base(NullLoggerFactory.Instance.CreateLogger("DynamoDBStorage"),
               AWSTestConstants.Service) {
      if (AWSTestConstants.IsDynamoDbAvailable) {
        InitializeTable(
            ...
            new List<KeySchemaElement>{
                ...
                new KeySchemaElement{AttributeName = "RowKey",
                                     KeyType = KeyType.RANGE}},
            new List<AttributeDefinition>{
                new AttributeDefinition{AttributeName = "PartitionKey",
                                        AttributeType = ScalarAttributeType.S},
                new AttributeDefinition{AttributeName = "RowKey",
                                        AttributeType = ScalarAttributeType.S}})
            .Wait();
      }
    }
