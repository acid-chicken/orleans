...
namespace Tester.AzureUtils.TimerTests {
  ...
  public class ReminderTests_AzureTable
      : ReminderTests_Base,
        IClassFixture<ReminderTests_AzureTable.Fixture> {
    ...
    public async Task
    Rem_Azure_Basic_StopByRef() {
      await Test_Reminders_Basic_StopByRef();
    }

    [SkippableFact, TestCategory("Functional")]
    public async Task
    Rem_Azure_Basic_ListOps() {
    ...
    [SkippableFact, TestCategory("Functional")]
    public async Task
    Rem_Azure_1J_MultiGrainMultiReminders() {
      await Test_Reminders_1J_MultiGrainMultiReminders();
    }

    [SkippableFact, TestCategory("Functional")]
    public async Task
    Rem_Azure_ReminderNotFound() {
    ...
    Rem_Azure_Basic() {
      ...
      IReminderTestGrain2 grain =
          this.GrainFactory.GetGrain<IReminderTestGrain2>(Guid.NewGuid());
      ...
      // retrieve the value of the counter-- it should match the sequence number
      // which is the number of periods we've waited.
    ...
    [SkippableFact, TestCategory("Functional")]
    public async Task
    Rem_Azure_2J_MultiGrainMultiReminders() {
      IReminderTestGrain2 g1 =
          this.GrainFactory.GetGrain<IReminderTestGrain2>(Guid.NewGuid());
      IReminderTestGrain2 g2 =
          this.GrainFactory.GetGrain<IReminderTestGrain2>(Guid.NewGuid());
      IReminderTestGrain2 g3 =
          this.GrainFactory.GetGrain<IReminderTestGrain2>(Guid.NewGuid());
      IReminderTestGrain2 g4 =
          this.GrainFactory.GetGrain<IReminderTestGrain2>(Guid.NewGuid());
      IReminderTestGrain2 g5 =
          this.GrainFactory.GetGrain<IReminderTestGrain2>(Guid.NewGuid());
      ...
      // start two extra silos ... although it will take it a while before they
      // stabilize
    ...
    [SkippableFact, TestCategory("Functional")]
    public async Task
    Rem_Azure_MultiGrainMultiReminders() {
      IReminderTestGrain2 g1 =
          this.GrainFactory.GetGrain<IReminderTestGrain2>(Guid.NewGuid());
      IReminderTestGrain2 g2 =
          this.GrainFactory.GetGrain<IReminderTestGrain2>(Guid.NewGuid());
    ...
    Rem_Azure_1F_Basic() {
      ...
      await this.HostedCluster.StopSiloAsync(
          this.HostedCluster.SecondarySilos.First());
    ...
    Rem_Azure_2F_MultiGrain() {
      ...
      await Task.WhenAll(tasks).WithTimeout(
          ENDWAIT); // Block until all tasks complete.
    }

    [SkippableFact, TestCategory("Functional")]
    public async Task
    Rem_Azure_1F1J_MultiGrain() {
      List<SiloHandle>silos =
      ...
      Task t1 = Task.Factory.StartNew(
          async () => await this.HostedCluster.StopSiloAsync(siloToKill));
      Task t2 =
          this.HostedCluster.StartAdditionalSilosAsync(1, true).ContinueWith(
    ...
    [SkippableFact, TestCategory("Functional")]
    public async Task
    Rem_Azure_RegisterSameReminderTwice() {
      IReminderTestGrain2 grain =
          this.GrainFactory.GetGrain<IReminderTestGrain2>(Guid.NewGuid());
    ...
    Rem_Azure_GT_Basic() {
      IReminderTestGrain2 g1 =
          this.GrainFactory.GetGrain<IReminderTestGrain2>(Guid.NewGuid());
      IReminderTestCopyGrain g2 =
          this.GrainFactory.GetGrain<IReminderTestCopyGrain>(Guid.NewGuid());
    ...
    [SkippableFact(Skip = "https://github.com/dotnet/orleans/issues/4319"),
     TestCategory("Functional")]
    public async Task
    Rem_Azure_GT_1F1J_MultiGrain() {
      List<SiloHandle>silos =
          await this.HostedCluster.StartAdditionalSilosAsync(1);
      await this.HostedCluster.WaitForLivenessToStabilizeAsync();
      ...
      IReminderTestGrain2 g2 =
          this.GrainFactory.GetGrain<IReminderTestGrain2>(Guid.NewGuid());
      IReminderTestCopyGrain g3 =
          this.GrainFactory.GetGrain<IReminderTestCopyGrain>(Guid.NewGuid());
      IReminderTestCopyGrain g4 =
          this.GrainFactory.GetGrain<IReminderTestCopyGrain>(Guid.NewGuid());
      ...
      Task t1 = Task.Run(
          async () => await this.HostedCluster.StopSiloAsync(siloToKill));
      Task t2 = Task.Run(
          async () => await this.HostedCluster.StartAdditionalSilosAsync(1));
      await Task.WhenAll(new[]{t1, t2}).WithTimeout(ENDWAIT);
    ...
    [SkippableFact, TestCategory("Functional")]
    public async Task
    Rem_Azure_Wrong_LowerThanAllowedPeriod() {
      IReminderTestGrain2 grain =
          this.GrainFactory.GetGrain<IReminderTestGrain2>(Guid.NewGuid());
    ...
    [SkippableFact, TestCategory("Functional")]
    public async Task
    Rem_Azure_Wrong_Grain() {
      IReminderGrainWrong grain =
          this.GrainFactory.GetGrain<IReminderGrainWrong>(0);
