...
namespace Tester.AzureUtils.Persistence {
  /// <summary>
  /// PersistenceStateTests using AzureStore - Requires access to external Azure
  /// blob storage
  /// </summary>
  [TestCategory("Persistence"), TestCategory("Azure")]
  public class PersistenceStateTests_AzureBlobStore
      : Base_PersistenceGrainTests_AzureStore,
        IClassFixture<PersistenceStateTests_AzureBlobStore.Fixture> {
    ...
    public PersistenceStateTests_AzureBlobStore(ITestOutputHelper output,
                                                Fixture fixture)
