...
namespace UnitTests.RemindersTest {
  ...
  public class AzureRemindersTableTests
      : ReminderTableTestsBase,
        IClassFixture<Tester.AzureUtils.AzureStorageBasicTests> {
    public AzureRemindersTableTests(ConnectionStringFixture fixture,
    ...
    [SkippableFact, TestCategory("Functional")]
    public async Task
    RemindersTable_Azure_RemindersParallelUpsert() {
      await RemindersParallelUpsert();
    }

    [SkippableFact, TestCategory("Functional")]
    public async Task
    RemindersTable_Azure_ReminderSimple() {
