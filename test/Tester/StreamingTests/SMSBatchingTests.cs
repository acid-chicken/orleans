...
namespace UnitTests.StreamingTests {
  [TestCategory("BVT")]
  public class SMSBatchingTests : StreamBatchingTestRunner,
                                  IClassFixture<SMSBatchingTests.Fixture> {
    public class Fixture : BaseTestClusterFixture {
      ...
      public class SiloConfigurator : ISiloConfigurator {
        public void Configure(ISiloBuilder hostBuilder) {
          hostBuilder.AddSimpleMessageStreamProvider(
              StreamBatchingTestConst.ProviderName,
