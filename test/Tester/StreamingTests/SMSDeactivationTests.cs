...
namespace UnitTests.StreamingTests {
  public class SMSDeactivationTests : TestClusterPerTest {
    ...
    public static readonly TimeSpan CollectionAge =
        GrainCollectionOptions.DEFAULT_COLLECTION_QUANTUM +
      ...
      public void Configure(ISiloBuilder hostBuilder) {
        hostBuilder
            ...
            .Configure<GrainCollectionOptions>(op => {
              ...
              op.ClassSpecificCollectionAge.Add(
                  typeof (MultipleSubscriptionConsumerGrain).FullName,
                  TimeSpan.FromHours(2));
            })
            .Configure<SiloMessagingOptions>(op => op.ResponseTimeout =
...
[Fact, TestCategory("Functional"), TestCategory("Streaming")]
public async Task
SMSDeactivationTest_ClientConsumer() {
  logger.Info(
      "************************ SMSDeactivationTest *********************************");
