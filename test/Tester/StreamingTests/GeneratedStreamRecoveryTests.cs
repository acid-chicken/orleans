...
namespace UnitTests.StreamingTests {
  public class GeneratedImplicitSubscriptionStreamRecoveryTests
      : OrleansTestingBase,
        IClassFixture<
            GeneratedImplicitSubscriptionStreamRecoveryTests.Fixture> {
    ...
    public GeneratedImplicitSubscriptionStreamRecoveryTests(Fixture fixture) {
      ...
      this.runner = new ImplicitSubscritionRecoverableStreamTestRunner(
          this.fixture.GrainFactory, Fixture.StreamProviderName);
    }
