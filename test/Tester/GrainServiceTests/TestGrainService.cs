...
namespace Tester {
public class TestGrainServiceClient : GrainServiceClient<ITestGrainService>,
                                      ITestGrainServiceClient {
  public TestGrainServiceClient(IServiceProvider serviceProvider)
  ...
  public Task<bool>HasStarted() { return GrainService.HasStarted(); }

  public Task<bool>HasStartedInBackground() {
    return GrainService.HasStartedInBackground();
  }

  public Task<bool>HasInit() { return GrainService.HasInit(); }
...
public class TestGrainService : GrainService, ITestGrainService {
  ...
  public TestGrainService(GrainId id, Silo silo, ILoggerFactory loggerFactory,
                          IOptions<TestGrainServiceOptions>options)
  ...
  public Task<bool>HasStarted() { return Task.FromResult(started); }

  public Task<bool>HasStartedInBackground() {
    return Task.FromResult(startedInBackground);
  }

  public Task<bool>HasInit() { return Task.FromResult(init); }
...
public static class TestGrainServicesSiloBuilderExtensions {
  public static ISiloBuilder AddTestGrainService(this ISiloBuilder builder,
                                                 string configProperty) {
    return builder.AddGrainService<TestGrainService>().ConfigureServices(
        services =>
            services
                .AddSingleton<ITestGrainServiceClient, TestGrainServiceClient>()
                .AddOptions<TestGrainServiceOptions>()
                .Configure(o => o.ConfigProperty = configProperty));
  }
}
