      ...
      clientBuilder
          .AddOutgoingGrainCallFilter(async ctx => {
            if (ctx.InterfaceMethod?.DeclaringType ==
                typeof (IOutgoingMethodInterceptionGrain)) {
...
[Fact]
public async Task
GrainCallFilter_Incoming_InvalidOrder_Test() {
  ...
  await Assert.ThrowsAsync<InvalidOperationException>(
      () => grain.CallWithBadInterceptors(true, false, false));
  await Assert.ThrowsAsync<InvalidOperationException>(
      () => grain.CallWithBadInterceptors(false, false, true));
  await Assert.ThrowsAsync<InvalidOperationException>(
      () => grain.CallWithBadInterceptors(false, true, false));
}
