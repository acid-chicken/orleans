...
namespace Orleans.SqlUtils.StorageProvider.GrainClasses {
  ...
  public class CustomerGrain : Grain<CustomerState>,
                               ICustomerGrain {
    ...
    public Task<string>IntroduceSelf() {
      return Task.FromResult(string.Format("Hello, my name is {0} {1}",
    ...
    public async Task SetRandomState() {
      ...
      var now = new DateTime(dt.Year, dt.Month, dt.Day, dt.Hour, dt.Minute,
                             dt.Second, DateTimeKind.Utc);
      ...
      State.BirthDate =
          new DateTime(_random.Next(40) + 1970, _random.Next(12) + 1,
                       _random.Next(28) + 1, 0, 0, 0, DateTimeKind.Utc);
