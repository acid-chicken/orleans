...
#endif
{
    ...
    private Dictionary<StreamSubscriptionHandle<T>, MyStreamObserver<T>> Observers {
        get;
        set;
    }
#else
    ...
    private Dictionary<StreamSubscriptionHandle<int>, MyStreamObserver<int>> Observers {
        get;
        set;
    }
#endif
