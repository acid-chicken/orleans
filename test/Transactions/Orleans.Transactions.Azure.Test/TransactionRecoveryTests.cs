...
namespace Orleans.Transactions.AzureStorage.Tests {
  ...
  public class TransactionRecoveryTests : TestClusterPerTest {
    ...
    public TransactionRecoveryTests(ITestOutputHelper helper) {
      ...
      this.testRunner =
          new TransactionRecoveryTestsRunnerxUnit(this.HostedCluster, helper);
    }
    ...
    protected override void ConfigureTestCluster(TestClusterBuilder builder) {
      ...
      builder.AddSiloBuilderConfigurator<
          SiloBuilderConfiguratorUsingAzureClustering>();
      builder.AddClientBuilderConfigurator<
          ClientBuilderConfiguratorUsingAzureClustering>();
    }
    ...
    public Task
    TransactionWillRecoverAfterRandomSiloGracefulShutdown(
        string transactionTestGrainClassName, int concurrent) {
      return this.testRunner
          .TransactionWillRecoverAfterRandomSiloGracefulShutdown(
              transactionTestGrainClassName, concurrent);
    }
    ...
    [InlineData(TransactionTestConstants.DoubleStateTransactionalGrain, 20)]
    public Task
    TransactionWillRecoverAfterRandomSiloUnGracefulShutdown(
        string transactionTestGrainClassName, int concurrent) {
      return this.testRunner
          .TransactionWillRecoverAfterRandomSiloUnGracefulShutdown(
              transactionTestGrainClassName, concurrent);
    ...
    private class ClientBuilderConfiguratorUsingAzureClustering
