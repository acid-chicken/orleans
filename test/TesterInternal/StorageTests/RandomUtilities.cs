...
public static class RandomUtilities
{
    ...
    private static Dictionary<Type, Func<IInternalGrainFactory, Type, bool, object, GrainReference>> GrainReferenceTypeSwitch {
        get;
    } = new Dictionary<Type, Func<IInternalGrainFactory, Type, bool, object, GrainReference>>
    {
    ...
    /// </summary>
    private static SafeRandom SafePseudoRandom {
        get;
    } = new SafeRandom();
    ...
    private static Dictionary<Type, object> RandomGenerators {
        get;
    } = new Dictionary<Type, object>
    {
        [typeof(Guid)] = new Func<object, Guid>(state => {
            return Guid.NewGuid();
        }),
        [typeof(int)] = new Func<object, int>(state => {
            return SafePseudoRandom.Next();
        }),
