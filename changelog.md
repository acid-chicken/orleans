...
-   Non-breaking improvements
    ...
    -   Change the error about not supported membership table cleanup
        functionality into a warning. (#6447)
    -   Update obsoletion warning for ISiloBuilderConfigurator (#6461)
    -   Allow GatewayManager initialization to be retried (#6459)

-   Non-breaking bug fixes
    -   Consistently sanitize RowKey & PartitionKey properties for Azure Table
        Storage reminders implementation (#6460)
...
-   Non-breaking improvements
    ...
    -   Move from WindowsAzure.Storage library to Microsoft.AzureCosmos.Table
        and Microsoft.Azure.Storage.\* packages. (#6013)
...
-   Breaking changes
    ...
    -   Deprecated the Orleans Logging infrastructure.
        ...
        -   The APM methods (TrackXXX) from `Logger` were separated into a new
...
-   Bug fixes
    ...
    -   Fix to make OrleansPerfCounterTelemetryConsumer still work for
        grain-specific counters. (part of #2807)
