...
internal class DbStoredQueries
{
    ...
    internal class Columns
    {
        ...
        {
            set {
                AddAddress(nameof(GatewayAddress), value);
            }
        }
        ...
        {
            set {
                AddGrainHash(nameof(BeginHash), value);
            }
        }
        ...
        {
            set {
                AddGrainHash(nameof(EndHash), value);
            }
        }
        ...
        {
            set {
                AddGrainHash(nameof(GrainHash), value);
            }
        }
        ...
        {
            set {
                AddAddress(nameof(Address), value);
            }
        }
        ...
        {
            set {
                Add(nameof(Version), int.Parse(value));
            }
        }
        ...
        {
            set {
                Add(nameof(GrainId), value, dbType: DbType.AnsiString);
            }
        }
