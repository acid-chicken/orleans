...
public class Silo
{
    ...
    public Task SiloTerminated {
        get {
            return this.siloTerminatedTask.Task;    // one event for all types of termination (shutdown, stop and fast kill).
        }
    }
