...
namespace Orleans.Runtime {
  /// <summary>
  /// Helper class used to create local instances of grains. In the future this
  /// should be opened up for extension similar to ASP.NET's ControllerFactory.
  /// </summary>
  internal class GrainCreator {
    ...
    /// </summary>
    /// <param name="grainActivator">The activator used to used to create new
    /// grains</param> <param name="getGrainRuntime">The delegate used to get
    /// the grain runtime.</param>
    public GrainCreator(IGrainActivator grainActivator,
    ...
    /// </summary>
    /// <param name="context">The <see cref="IGrainActivationContext"/> for the
    /// executing action.</param> <returns>The newly created grain.</returns>
