...
internal class ActivationData : IGrainActivationContext, IActivationData, IInvokable, IDisposable
{
    ...
    public HashSet<ActivationId> RunningRequestsSenders {
        get;
    ...
    public long InFlightCount {
        get {
            return Interlocked.Read(ref inFlightCount);
        }
    }
    ...
    public long EnqueuedOnDispatcherCount {
        get {
            return Interlocked.Read(ref enqueuedOnDispatcherCount);
        }
    }
    ...
    public bool ShouldBeKeptAlive {
        get {
            return keepAliveUntil >= DateTime.UtcNow;
        }
    }
