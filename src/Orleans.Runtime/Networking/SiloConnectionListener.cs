...
namespace Orleans.Runtime.Messaging {
  internal sealed class SiloConnectionListener
    ...
    public SiloConnectionListener(
        ...
        MessageCenter messageCenter, IOptions<EndpointOptions>endpointOptions,
    ...
    public override EndPoint Endpoint =>
        this.endpointOptions.GetListeningSiloEndpoint();

    protected override Connection CreateConnection(ConnectionContext context) {
      return new SiloConnection(default(SiloAddress), context,
                                this.ConnectionDelegate, this.messageCenter,
                                this.localSiloDetails, this.connectionManager,
                                this.ConnectionOptions, this.connectionShared);
    }
    ...
    void ILifecycleParticipant<ISiloLifecycle>.Participate(
      ...
      lifecycle.Subscribe(nameof(SiloConnectionListener),
