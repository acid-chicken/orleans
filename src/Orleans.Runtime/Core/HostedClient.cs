  ...
  internal sealed class HostedClient : IDisposable,
    ...
    public HostedClient(IRuntimeClient runtimeClient,
      ...
      this.ClientAddress = ActivationAddress.NewActivationAddress(
          siloDetails.SiloAddress, GrainId.NewClientId());
    }
    ...
    public GrainReference CreateObjectReference(IAddressable obj,
      ...
      var grainReference = GrainReference.NewObserverGrainReference(
          this.ClientAddress.Grain, GuidId.GetNewGuidId(),
          this.grainReferenceRuntime);
      if (!this.invokableObjects.TryRegister(obj, grainReference.ObserverId,
                                             invoker)) {
        throw new ArgumentException(
            string.Format(
    ...
    public void DeleteObjectReference(IAddressable obj) {
      ...
      if (!this.invokableObjects.TryDeregister(reference.ObserverId))
        throw new ArgumentException(
            "Reference is not associated with a local object.", nameof(obj));
    }
    ...
    public bool TryDispatchToClient(Message message) {
      if (!this.ClientId.Equals(message.TargetGrain))
        return false;
