...
namespace Orleans.Runtime {
  ...
  internal class InsideRuntimeClient : ISiloRuntimeClient,
    ...
    private HostedClient HostedClient => this.hostedClient ??(
        this.hostedClient =
            this.ServiceProvider.GetRequiredService<HostedClient>());
    ...
    public void SendRequest(GrainReference target, InvokeMethodRequest request,
      ...
      if (targetGrainId.IsSystemTarget()) {
        ...
        message.Category =
            targetGrainId.Type.Equals(Constants.MembershipOracleType)
    ...
    private bool TryInstallExtension(int interfaceId, IInvokable invokable,
      ...
      IGrainExtension extension =
          RuntimeContext
              .CurrentGrainContext is ActivationData activationData
                                    ?
    ...
    public string CurrentActivationIdentity =>
        RuntimeContext.CurrentGrainContext?.Address.ToString()
        ?? this.HostedClient.ToString();
    ...
    BindExtension<TExtension, TExtensionInterface>(
      ...
      IAddressable currentGrain =
          RuntimeContext.CurrentGrainContext?.GrainInstance;
    ...
    private ExtensionInvoker GetCurrentExtensionInvoker() {
      return RuntimeContext.CurrentGrainContext switch {
          ...
          _ => throw new InvalidOperationException(
              "Attempting to GetCurrentExtensionInvoker when not in an activation scope")};
    }
