...
namespace Orleans.Runtime.Scheduler {
  internal class ClosureWorkItem : WorkItemBase {
    ...
    public ClosureWorkItem(Action closure) { continuation = closure; }
    ...
    internal static string GetMethodName(Delegate action) {
      ...
      return string.Format("{0}->{1}",
                           ...
                           ?? string.Empty,
                           continuationMethodInfo == null ? string.Empty
                           : continuationMethodInfo.ToString());
    }
  }
  ...
  internal class AsyncClosureWorkItem : WorkItemBase {
    ...
    public override string Name =>
        this.name ?? ClosureWorkItem.GetMethodName(this.continuation);
