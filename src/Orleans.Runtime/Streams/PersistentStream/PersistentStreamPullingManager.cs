...
namespace Orleans.Streams {
  internal class PersistentStreamPullingManager
    ...
    internal PersistentStreamPullingManager(
        SystemTargetGrainId managerId, string strProviderName,
        IStreamProviderRuntime runtime, IStreamPubSub streamPubSub,
        IQueueAdapterFactory adapterFactory,
        IStreamQueueBalancer streamQueueBalancer,
        StreamPullingAgentOptions options, ILoggerFactory loggerFactory,
        SiloAddress siloAddress)
        : base(managerId, siloAddress, lowPriority
               : false, loggerFactory) {
    ...
    private async Task AddNewQueues(IEnumerable<QueueId>myQueues,
      ...
      foreach(var queueId in myQueues) {
        ...
        try {
          ...
          var agentId = SystemTargetGrainId.Create(
              Constants.StreamPullingAgentType, this.Silo,
              $"{streamProviderName}_{agentIdNumber}_{queueId.ToStringWithHashCode()}");
