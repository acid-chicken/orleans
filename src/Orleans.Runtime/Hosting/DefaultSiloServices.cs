...
namespace Orleans.Hosting {
  internal static class DefaultSiloServices {
    ...
    AddDefaultServices(IApplicationPartManager applicationPartManager,
      ...
      if (services.FirstOrDefault(service => service.ServiceType ==
                                             typeof (IGrainDirectory)) !=
          null) {
      ...
      services.TryAddFromExisting<ILifecycleParticipant<ISiloLifecycle>,
                                  ClientObserverRegistrar>();
      ...
      services.TryAddSingleton<Factory<Grain, ILogConsistencyProtocolServices>>(
          FactoryUtility.Create<Grain, ProtocolServices>);
