...
namespace Orleans.Runtime {
  ...
  internal class ActivationAddress {
    ...
    private ActivationAddress(SiloAddress silo, GrainId grain,
    ...
    public static ActivationAddress NewActivationAddress(SiloAddress silo,
                                                         GrainId grain) {
      var activation = ActivationId.NewId();
      return GetAddress(silo, grain, activation);
    }

    public static ActivationAddress GetAddress(SiloAddress silo, GrainId grain,
                                               ActivationId activation) {
    ...
    public override bool Equals(object obj) {
      ...
      return other != null && Equals(Silo, other.Silo) &&
             Equals(Grain, other.Grain) && Equals(Activation, other.Activation);
    }
