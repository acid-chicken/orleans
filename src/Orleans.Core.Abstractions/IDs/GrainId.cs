...
namespace Orleans.Runtime {
  [Serializable]
  internal class GrainId : UniqueIdentifier,
                           IEquatable<GrainId>,
                           IGrainIdentity {
    ...
    public static GrainId NewClientId() { return NewClientId(Guid.NewGuid()); }
    ...
    internal static GrainId GetSystemGrainId(Guid guid) {
      return FindOrCreateGrainId(
          UniqueKey.NewKey(guid, UniqueKey.Category.SystemGrain));
    }
    ...
    internal static GrainId NewSystemTargetGrainIdByTypeCode(int typeData) {
      return FindOrCreateGrainId(
          UniqueKey.NewSystemTargetKey(Guid.NewGuid(), typeData));
    }
    ...
    internal static GrainId GetGrainId(long typeCode, long primaryKey,
                                       string keyExt = null) {
      return FindOrCreateGrainId(
    ...
    internal static GrainId GetGrainId(long typeCode, Guid primaryKey,
                                       string keyExt = null) {
      return FindOrCreateGrainId(
          UniqueKey.NewKey(primaryKey, keyExt == null ? UniqueKey.Category.Grain
                           : UniqueKey.Category.KeyExtGrain, typeCode, keyExt));
    ...
    internal static GrainId GetGrainServiceGrainId(int typeData,
    ...
    private static GrainId FindOrCreateGrainId(UniqueKey key) {
      ...
      lock(lockable) {
        if (grainIdInternCache == null) {
          grainIdInternCache = new Interner<UniqueKey, GrainId>(
    ...
    /// <summary>
    /// Return this GrainId in a standard string form, suitable for later use
    /// with the <c>FromParsableString</c> method.
    /// </summary>
    ...
    /// <summary>
    /// Return this GrainId in a standard components form, suitable for later
    /// use with the <see cref="FromKeyInfo"/> method.
    /// </summary>
    ...
    /// <summary>
    /// Create a new GrainId object by parsing string in a standard form
    /// returned from <c>ToParsableString</c> method.
    /// </summary>
    /// <param name="grainId">String containing the GrainId info to be
    /// parsed.</param> <returns>New GrainId object created from the input
    /// data.</returns>
    ...
    /// <summary>
    /// Create a new GrainId object by parsing components returned form <see
    /// cref="ToKeyInfo"/>.
    /// </summary>
    /// <param name="grainId">Components containing the GrainId to be
    /// parsed.</param> <returns>New GrainId object created from the input
    /// data.</returns>
