...
public interface IGrainFactory {
  ...
  /// <param name="grainClassNamePrefix">An optional class name prefix used to
  /// find the runtime type of the grain.</param> <returns>A reference to the
  /// specified grain.</returns>
  TGrainInterface GetGrain<TGrainInterface>(Guid primaryKey,
  ...
  /// find the runtime type of the grain.</param> <returns>A reference to the
  /// specified grain.</returns>
  TGrainInterface GetGrain<TGrainInterface>(long primaryKey,
                                            string grainClassNamePrefix = null)
  ...
  /// find the runtime type of the grain.</param> <returns>A reference to the
  /// specified grain.</returns>
  TGrainInterface GetGrain<TGrainInterface>(string primaryKey,
                                            string grainClassNamePrefix = null)
  ...
  TGrainInterface GetGrain<TGrainInterface>(
      Guid primaryKey, string keyExtension, string grainClassNamePrefix = null)
  ...
  /// specified grain.</returns>
  TGrainInterface GetGrain<TGrainInterface>(
      long primaryKey, string keyExtension, string grainClassNamePrefix = null)
  ...
  Task<TGrainObserverInterface>CreateObjectReference<TGrainObserverInterface>(
  ...
  Task DeleteObjectReference<TGrainObserverInterface>(IGrainObserver obj)
  ...
  /// <summary>
  /// A GetGrain overload that returns the runtime type of the grain interface
  /// and returns the grain cast to TGrainInterface.
  ///
  /// The main use-case is when you want to get a grain whose type is unknown at
  /// compile time (e.g. generic type parameters).
  /// </summary>
  ...
  /// interface</param> <returns>the requested grain with the given grainID and
  /// grainInterfaceType</returns>
  TGrainInterface GetGrain<TGrainInterface>(Type grainInterfaceType,
  ...
  /// grainInterfaceType</returns>
  TGrainInterface GetGrain<TGrainInterface>(
      Type grainInterfaceType, Guid grainPrimaryKey, string keyExtension)
      where TGrainInterface : IGrain;
  ...
  /// grainInterfaceType</returns>
  TGrainInterface GetGrain<TGrainInterface>(
      Type grainInterfaceType, long grainPrimaryKey, string keyExtension)
      where TGrainInterface : IGrain;

  /// <summary>
  /// A GetGrain overload that returns the runtime type of the grain interface
  /// and returns the grain cast to <see paramref="TGrainInterface"/>. It is the
  /// caller's responsibility to ensure <see paramref="TGrainInterface"/>
  ...
  /// <param name="grainPrimaryKey">the primary key of the grain</param>
  /// <param name="grainInterfaceType">the runtime type of the grain
  /// interface</param> <returns></returns>
