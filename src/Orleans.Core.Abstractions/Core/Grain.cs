...
public abstract class Grain : IAddressable, ILifecycleParticipant<IGrainLifecycle>
{
    ...
    {
        get {
            return Data?.ServiceProvider ?? Runtime?.ServiceProvider;
        }
    }
    ...
    {
        get {
            return Runtime?.SiloIdentity ?? string.Empty;
        }
    }
    ...
    {
        get {
            return Runtime?.SiloAddress ?? SiloAddress.Zero;
        }
    }
