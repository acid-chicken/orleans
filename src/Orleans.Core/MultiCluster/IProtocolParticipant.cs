...
namespace Orleans.MultiCluster {
  /// <summary>
  /// Grain interface for grains that participate in multi-cluster
  /// log-consistency protocols.
  /// </summary>
  public interface ILogConsistencyProtocolParticipant : IGrain {
    /// <summary>
    /// Called immediately before the user-level OnActivateAsync, on same
    /// scheduler.
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Called immediately after the user-level OnActivateAsync, on same
    /// scheduler.
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Called immediately after the user-level OnDeactivateAsync, on same
    /// scheduler.
    /// </summary>
    /// <returns></returns>
