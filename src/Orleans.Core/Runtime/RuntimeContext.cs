...
{
    public ISchedulingContext ActivationContext {
        get;
        private set;
    }
    ...
    public static RuntimeContext Current {
        [MethodImpl(MethodImplOptions.AggressiveInlining)] get => context ??= new RuntimeContext();
    }

    internal static ISchedulingContext CurrentActivationContext {
        [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Current?.ActivationContext;
    }
