...
internal class InvokableObjectManager : IDisposable {
  ...
  private readonly ConcurrentDictionary<GuidId, LocalObjectData>localObjects =
      new ConcurrentDictionary<GuidId, LocalObjectData>();
  ...
  public bool TryRegister(IAddressable obj, GuidId objectId,
  ...
  public class LocalObjectData {
    ...
    internal LocalObjectData(IAddressable obj, GuidId observerId,
                             IGrainMethodInvoker invoker) {
