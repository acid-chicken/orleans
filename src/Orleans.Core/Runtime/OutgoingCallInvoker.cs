...
namespace Orleans.Runtime {
  ...
  internal class OutgoingCallInvoker : IOutgoingGrainCallContext {
    ...
    private readonly Func<GrainReference, InvokeMethodRequest,
                          InvokeMethodOptions, Task<object>>sendRequest;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OutgoingCallInvoker"/>
    /// class.
    /// </summary>
    ...
    public OutgoingCallInvoker(
        GrainReference grain, InvokeMethodRequest request,
        InvokeMethodOptions options,
        Func<GrainReference, InvokeMethodRequest, InvokeMethodOptions,
    ...
    public MethodInfo Method {
      get {
        ...
        var implementationMap =
            mapping.GetOrCreate(implementationType, request.InterfaceId);
    ...
    public async Task Invoke() {
      try {
        ...
        if (stage == numFilters) {
          ...
          stage++;
          var resultTask =
              this.sendRequest(this.grainReference, this.request, this.options);
          if (resultTask != null) {
