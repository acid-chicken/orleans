...
namespace Orleans.Runtime {
  ...
  internal class OutgoingCallInvoker : IOutgoingGrainCallContext {
    ...
    public async Task Invoke() {
      // Execute each stage in the pipeline. Each successive call to this method
      // will invoke the next stage. Stages which are not implemented (eg,
      // because the user has not specified an interceptor) are skipped.
