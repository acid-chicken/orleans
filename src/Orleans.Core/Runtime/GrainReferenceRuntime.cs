...
namespace Orleans.Runtime {
  internal class GrainReferenceRuntime : IGrainReferenceRuntime {
    ...
    public GrainReferenceRuntime(
      ...
      this.GrainReferenceFactory =
          new GrainReferenceFactory(typeMetadataCache, this);
    ...
    public TGrainInterface Convert<TGrainInterface>(IAddressable grain) =>
        (TGrainInterface) this.GrainReferenceFactory.Cast(
            grain, typeof(TGrainInterface));
    ...
    private bool IsUnordered(GrainReference reference) {
      return LegacyGrainId.TryConvertFromGrainId(reference.GrainId,
                                                 out var legacyId) &&
             this.RuntimeClient.GrainTypeResolver is IGrainTypeResolver
                 resolver &&
