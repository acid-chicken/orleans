...
internal class Message
{
    ...
    {
        get {
            return Headers.Direction ?? default(Directions);
        }
        set {
            Headers.Direction = value;
        }
    }
    ...
    {
        get {
            return Headers.IsAlwaysInterleave;
        }
        set {
            Headers.IsAlwaysInterleave = value;
        }
    }
    ...
    {
        get {
            return Headers.IsUnordered;
        }
        set {
            Headers.IsUnordered = value;
        }
    }
    ...
    {
        get {
            return Headers.IsReturnedFromRemoteCluster;
        }
        set {
            Headers.IsReturnedFromRemoteCluster = value;
        }
    }
    ...
    {
        get {
            return Headers.IsTransactionRequired;
        }
        set {
            Headers.IsTransactionRequired = value;
        }
    }
    ...
    {
        get {
            return Headers.ForwardCount;
        }
        set {
            Headers.ForwardCount = value;
        }
    }
    ...
    {
        get {
            return Headers.TargetActivation;
        }
        set
        {
    ...
    {
        get {
            return targetAddress ?? (targetAddress = ActivationAddress.GetAddress(TargetSilo, TargetGrain, TargetActivation));
        }
        set
        {
    ...
    {
        get {
            return Headers.TargetObserverId;
        }
        set
        {
    ...
    {
        get {
            return Headers.SendingActivation;
        }
        set
        {
    ...
    {
        get {
            return Headers.CallChainId;
        }
        set {
            Headers.CallChainId = value;
        }
    }

    public TraceContext TraceContext {
        get {
            return Headers.TraceContext;
        }
        set {
            Headers.TraceContext = value;
        }
    }
    ...
    {
        get {
            return sendingAddress ?? (sendingAddress = ActivationAddress.GetAddress(SendingSilo, SendingGrain, SendingActivation));
        }
        set
        {
    ...
    {
        get {
            return Headers.IsUsingIfaceVersion;
        }
        set
        {
    ...
    {
        get {
            return Headers.TimeToLive;
        }
        set {
            Headers.TimeToLive = value;
        }
    }
    ...
    {
        get {
            return Headers.TransactionInfo;
        }
        set {
            Headers.TransactionInfo = value;
        }
    }
    ...
    {
        get {
            return GetNotNullString(Headers.DebugContext);
        }
        set {
            Headers.DebugContext = value;
        }
    }
    ...
    {
        get {
            return Headers.CacheInvalidationHeader;
        }
        set {
            Headers.CacheInvalidationHeader = value;
        }
    }
    ...
    {
        get {
            return GetNotNullString(Headers.NewGrainType);
        }
        set {
            Headers.NewGrainType = value;
        }
    }
    ...
    {
        get {
            return GetNotNullString(Headers.GenericGrainType);
        }
        set {
            Headers.GenericGrainType = value;
        }
    }
    ...
    {
        get {
            return Headers.RejectionType;
        }
        set {
            Headers.RejectionType = value;
        }
    }
    ...
    {
        get {
            return GetNotNullString(Headers.RejectionInfo);
        }
        set {
            Headers.RejectionInfo = value;
        }
    }
    ...
    {
        get {
            return Headers.RequestContextData;
        }
        set {
            Headers.RequestContextData = value;
        }
    }
    ...
    public class HeadersContainer
    {
        ...
        {
            get {
                return _isReturnedFromRemoteCluster;
            }
            set
            {
        ...
        {
            get {
                return _cacheInvalidationHeader;
            }
            set
            {
