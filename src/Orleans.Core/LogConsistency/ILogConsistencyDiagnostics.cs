...
namespace Orleans.LogConsistency {
  ...
  public interface ILogConsistencyDiagnostics {
    /// <summary>Turns on the statistics collection for this log-consistent
    /// grain.</summary>
    void EnableStatsCollection();

    /// <summary>Turns off the statistics collection for this log-consistent
    /// grain.</summary>
    void DisableStatsCollection();

    /// <summary>Gets the collected statistics for this log-consistent
    /// grain.</summary>
    LogConsistencyStatistics GetStats();
  }

  /// <summary>
  /// A collection of statistics for grains using log-consistency. See <see
  /// cref="LogConsistentGrain{T}"/>
  /// </summary>
