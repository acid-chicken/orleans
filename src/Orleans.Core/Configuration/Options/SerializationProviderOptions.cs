...
namespace Orleans.Configuration {
  ...
  public class SerializationProviderOptions {
    ...
    /// </summary>
    public List<Type>SerializationProviders {
      get;
      set;
    }
    = new List<Type>();
    ...
    /// </summary>
    public Type FallbackSerializationProvider {
      get;
      set;
    }

    /// <summary>
    /// The maximum retained size for serialization and deserialization
    /// contexts.
    /// </summary>
    /// <remarks>
    /// This should reflect the expected object graph size for messages.
    /// </remarks>
    public int MaxSustainedSerializationContextCapacity {
      get;
      set;
    }
    = 64;
