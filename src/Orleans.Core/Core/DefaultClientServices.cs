...
internal static class DefaultClientServices {
  public static void AddDefaultServices(IClientBuilder builder,
    ...
    services.AddFromExisting<ILifecycleParticipant<IClusterClientLifecycle>,
                             ClientOptionsLogger>();
    ...
    services
        .TryAddSingleton<IAppEnvironmentStatistics, AppEnvironmentStatistics>();
    ...
    services.TryAddFromExisting<IClusterConnectionStatusListener,
    ...
    services
        .TryAddFromExisting<IStreamProviderRuntime, ClientProviderRuntime>();
    ...
    services.TryAddSingleton<SerializationManager>(
        sp => ActivatorUtilities.CreateInstance<SerializationManager>(
            sp, sp.GetRequiredService<IOptions<ClientMessagingOptions>>()
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    // Add default option formatter if none is configured, for options which are
    // requied to be configured
    ...
    services.AddSingleton<
        ...
        ConnectionManagerLifecycleAdapter<IClusterClientLifecycle>>();
    ...
    services
        .TryAddSingleton<ConnectionFactory, ClientOutboundConnectionFactory>();
    services.TryAddSingleton<ClientMessageCenter>(
        sp => sp.GetRequiredService<OutsideRuntimeClient>().MessageCenter);
