...
namespace Orleans.Runtime.Messaging {
  internal sealed class ClientOutboundConnectionFactory
    ...
    public ClientOutboundConnectionFactory(
        ...
        : base(connectionShared.ServiceProvider
    ...
    protected override Connection CreateConnection(SiloAddress address,
      ...
      return new ClientOutboundConnection(
          address, context, this.ConnectionDelegate, this.messageCenter,
    ...
    ConfigureConnectionBuilder(IConnectionBuilder connectionBuilder) {
      ...
      this.clientConnectionOptions.ConfigureConnectionBuilder(
          connectionBuilder);
    ...
    private void EnsureInitialized() {
      if (!isInitialized) {
        lock(this.initializationLock) {
          if (!isInitialized) {
            this.messageCenter = this.connectionShared.ServiceProvider
                                     .GetRequiredService<ClientMessageCenter>();
