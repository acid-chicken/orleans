...
namespace Orleans.Transactions.TestKit.xUnit {
  public class GrainFaultTransactionTestRunnerxUnit
      : GrainFaultTransactionTestRunner {
    public GrainFaultTransactionTestRunnerxUnit(IGrainFactory grainFactory,
        ...
        : base(grainFactory, output.WriteLine){}
          ...
          AbortTransactionOnExceptions(string grainStates) {
    ...
    [InlineData(TransactionTestConstants.MaxStateTransactionalGrain)]
    public override Task
    AbortTransactionOnOrphanCalls(string grainStates) {
