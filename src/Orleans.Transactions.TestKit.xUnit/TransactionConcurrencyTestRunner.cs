...
namespace Orleans.Transactions.TestKit.xUnit {
  public abstract class TransactionConcurrencyTestRunnerxUnit
      : TransactionConcurrencyTestRunner {
    protected TransactionConcurrencyTestRunnerxUnit(IGrainFactory grainFactory,
    ...
    TransactionChainTest(string grainStates) {
    ...
    [InlineData(TransactionTestConstants.MaxStateTransactionalGrain)]
    public override Task
    TransactionTreeTest(string grainStates) {
