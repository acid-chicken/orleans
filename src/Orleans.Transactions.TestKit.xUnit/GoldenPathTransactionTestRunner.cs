...
namespace Orleans.Transactions.TestKit.xUnit {
  public abstract class GoldenPathTransactionTestRunnerxUnit
      : GoldenPathTransactionTestRunner {
    protected GoldenPathTransactionTestRunnerxUnit(IGrainFactory grainFactory,
    ...
    SingleGrainWriteTransaction(string grainStates) {
    ...
    [InlineData(TransactionTestConstants.DoubleStateTransactionalGrain,
                TransactionTestConstants.MaxCoordinatedTransactions / 2)]
    [InlineData(TransactionTestConstants.MaxStateTransactionalGrain, 1)]
    public override Task
    MultiGrainWriteTransaction(string grainStates, int grainCount) {
    ...
    [InlineData(TransactionTestConstants.MaxStateTransactionalGrain, 1)]
    public override Task
    MultiGrainReadWriteTransaction(string grainStates, int grainCount) {
    ...
    [InlineData(TransactionTestConstants.MaxStateTransactionalGrain, 1)]
    public override Task
    RepeatGrainReadWriteTransaction(string grainStates, int grainCount) {
    ...
    [InlineData(TransactionTestConstants.MaxStateTransactionalGrain)]
    public override Task
    MultiWriteToSingleGrainTransaction(string grainStates) {
    ...
    [InlineData(TransactionTestConstants.MaxStateTransactionalGrain, 1)]
    public override Task
    RWRWTest(string grainStates, int grainCount) {
    ...
    [InlineData(TransactionTestConstants.MaxStateTransactionalGrain, 1)]
    public override Task
    WRWRTest(string grainStates, int grainCount) {
