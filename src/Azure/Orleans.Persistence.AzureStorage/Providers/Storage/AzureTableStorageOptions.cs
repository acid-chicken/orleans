...
namespace Orleans.Configuration {
  ...
  /// </summary>
  public class AzureTableGrainStorageOptionsValidator
    ...
    public AzureTableGrainStorageOptionsValidator(
        AzureTableStorageOptions options, string name) {
    ...
    public void ValidateConfiguration() {
      ...
      try {
        ...
        throw new OrleansConfigurationException(
            $"Configuration for AzureTableStorageProvider {name} is invalid. {nameof(this.options.TableName)} is not valid",
            e);
      }
    }
  }
