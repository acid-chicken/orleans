...
namespace Orleans.Transactions.TestKit {
  public class FaultInjectionAzureTableTransactionStateStorage<TState>
      : ITransactionalStateStorage<TState>where TState : class, new () {
    ...
    public FaultInjectionAzureTableTransactionStateStorage(
    ...
    )
    {
      ...
      var result = await this.stateStorage.Store(
          expectedETag, metadata, statesToPrepare, commitUpTo, abortAfter);
      faultInjector.AfterStore();
      return result;
    }
  }

  public class FaultInjectionAzureTableTransactionStateStorageFactory
    ...
    Create(IServiceProvider services, string name) {
      ...
      return new FaultInjectionAzureTableTransactionStateStorageFactory(
          azureFactory);
    }
