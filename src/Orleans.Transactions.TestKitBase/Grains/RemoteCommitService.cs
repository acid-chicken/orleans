...
namespace Orleans.Transactions.TestKit {
  ...
  // - can be called to verify that commit service receive Callme with proper
  // args.
  ...
  public class PassOperation
      : ITransactionCommitOperation<IRemoteCommitService>{
            public string Data{get;
  set;
}

public PassOperation(string data) { this.Data = data; }

public async Task<bool>Commit(Guid transactionId,
                              IRemoteCommitService service) {
...
public class FailOperation
    : ITransactionCommitOperation<IRemoteCommitService>{public string Data{get;
set;
}

public FailOperation(string data) { this.Data = data; }
...
public class ThrowOperation
  ...
  public ThrowOperation(string data) { this.Data = data; }
