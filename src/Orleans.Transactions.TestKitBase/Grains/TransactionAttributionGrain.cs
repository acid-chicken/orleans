...
namespace Orleans.Transactions.TestKit {
  ...
  public class CreateOrJoinAttributionGrain : Grain,
  ...
  internal static class AttributionGrain {
    ...
    GetNestedTransactionIds(int tier,
      ...
      List<string>[][] tiersResults = await Task.WhenAll(
          nextTier.Select(g => g.GetNestedTransactionIds(tier + 1, nextTiers)));
