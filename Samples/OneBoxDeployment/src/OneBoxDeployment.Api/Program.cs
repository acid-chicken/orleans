...
namespace OneBoxDeployment.Api {
  ...
  public static class Program {
    ...
    /// </summary>
    /// <param name="args">The command line arguments used to run this
    /// application.</param>
    ...
    /// </summary>
    /// <param name="args">The command line arguments used to run this
    /// application.</param> <returns>The command line arguments used to run
    /// this application.</returns>
    public static IWebHost BuildWebHost(string[] args) {
      return InternalBuildWebHost(args, new Dictionary<string, string>(),
    ...
    /// </summary>
    /// <param name="args">The command line arguments used to run this
    /// application.</param> <param name="settingsOverrides">A collection of
    /// well-known key-value configuration values for the application. These
    /// settings are applied after appsettings.{env.EnvironmentName}.json, so
    /// they override them.</param> <param name="loggerProviders">Extra
    /// providers to be added to the system.</param> <returns>The command line
    /// arguments used to run this application.</returns>
    public static IWebHost
    InternalBuildWebHost(string[] args,
                         Dictionary<string, string>settingsOverrides,
                         IEnumerable<ILoggerProvider>loggerProviders) {
      // The initial build needs to be done like this to include command line
      // arguments. See bug
      ...
      return new WebHostBuilder()
          ...
          .ConfigureAppConfiguration((builderContext, config) => {
            ...
            config
                .AddJsonFile("appsettings.api.json", optional
                             : false, reloadOnChange
                             : true)
                .AddJsonFile($"appsettings.api.{env.EnvironmentName}.json",
                             optional
                             : false, reloadOnChange
                             : true);
          ...
          .ConfigureLogging((hostingContext, loggingBuilder) => {
            ...
            var loggerConfiguration =
                new LoggerConfiguration().ReadFrom.Configuration(section);
