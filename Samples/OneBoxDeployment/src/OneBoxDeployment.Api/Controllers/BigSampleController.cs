...
namespace OneBoxDeployment.Api.Controllers {
  ...
  [Consumes("application/json")]
    ...
    public OneBoxDeploymentController(ILogger<OneBoxDeploymentController>logger,
    ...
    Increment(Increment increment) {
      ...
      Logger.LogInformation(Events.TestEvent.Id, Events.TestEvent.FormatString,
                            increment);

      var testStateGrain =
          ClusterClient.GetGrain<ITestStateGrain>(increment.GrainId);
      var currentState = await testStateGrain.Increment(increment.IncrementBy)
