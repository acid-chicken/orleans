...
namespace AspNetCoreHostedServices.Silo {
  public class HelloWorldSiloHostedService : IHostedService {
    ...
    public HelloWorldSiloHostedService(
        ILogger<HelloWorldSiloHostedService>logger,
      ...
      var silo =
          new SiloHostBuilder()
              ...
              .Configure<EndpointOptions>(
                  opts => { opts.AdvertisedIPAddress = IPAddress.Loopback; })
              .ConfigureApplicationParts(manager => {
                manager.AddApplicationPart(typeof (HelloWorldGrain).Assembly)
                    .WithReferences();
              })
    ...
    public Task StartAsync(CancellationToken cancellationToken) =>
        this.Silo.StartAsync(cancellationToken);

    public Task StopAsync(CancellationToken cancellationToken) =>
        this.Silo.StopAsync(cancellationToken);
  }
}
